...
accl_target_u_0 = torch.load("./sph_les/validate_code/validate_code_u=0.pt", map_location=torch.device('cpu'))
accl_target_u_not_0 = torch.load("./sph_les/validate_code/validate_code_u!=0.pt",  map_location=torch.device('cpu'))
