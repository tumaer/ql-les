#nohup bash /home/tkalinov/code/sph_les_directory/sph_les/src/validate_code/tgv_lagrbench/schedule_lagbench.sh > /home/tkalinov/code/sph_les_directory/sph_les/src/validate_code/tgv_lagrbench/gns_LB_64.log &
